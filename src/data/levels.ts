...
export const levels: Level[] = [
    ...
    },
    {
        ...
        question: 'แงความยาวคลื่น 600 นาโนเมตร ตกกระทบผิวโพแทซียมที่มีฟังก์ชันงาน 2.3 อิเล็กตรอนโวลต์จะมีอิเล็กตรอนลุดออกมาหรือไม่ ถ้ามี พลังงานของโฟโตอิเล็กตรอนเล่านี้มีค่าเท่าใด และถ้าไม่มีพลังงานที่ต้องเพิ่มมีค่าอย่างน้อยเท่าใด',
        options: [
            '0.23 eV',
            '0.44 eV',
            '1.23 eV',
    ...
    },
    {
        ...
        question: 'ในการทดลองปรากฏการณ์โฟโตอิเล็กทริก เมื่อฉายแงตกกระทบผิวโละชนิดนึ่ง พบว่าความต่างศักย์ยุดยั้งเท่ากับ 3.7 โวลต์ พลังงานจลน์ูงุดของอิเล็กตรอนมีค่าเท่าใด ในน่วยจูลและในน่วยอิเล็กตรอนโวลต์?',
        options: [
            '0.3 eV',
            '8.2 eV',
            '3.7 eV',
